package de.uni_koeln.spinfo.textengineering.ir.webIR;
...
import de.uni_koeln.spinfo.textengineering.ir.webIR.crawler.Crawler;
import de.uni_koeln.spinfo.textengineering.ir.webIR.crawler.Parser;
 ...
 */
public final class TestCrawler {
	...
	public void connect() throws IOException {
		...
		/*
		 * Wir bekommen für die URL einen stream, den wir in einer Schleife (oder mit Apache Commons IO) lesen könnten:
		 */
	...
	public void crawlLevel1() {
		...
		Assert.assertTrue(Crawler.crawl(1, seed).size() > seed.size()
				* linksPerSite);
	}
