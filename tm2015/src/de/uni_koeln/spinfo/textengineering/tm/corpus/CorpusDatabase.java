...
public final class CorpusDatabase implements Corpus {
	/*
	 * Diese Implementierung basiert auf DB4O. Bräuchte man eine Alternative (z.B. eine relationale DB oder XML), könnte
	 * man eine weitere Implementierung des Corpus-Interface erstellen, die das Ganze auf ihre Weise regelt. Die
	 * Klassen, die das Korpus über das Interface benutzen, müssten nicht angepasst werden.
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see de.uni_koeln.spinfo.textengineering.tm.corpus.Corpus#getDocuments(java.lang.Class)
	 */
