...
class Extractor {
	...
	/**
	 * @param location
	 *            The location this extractor should work for
	 */
	...
	/**
	 * @param string
	 *            The URL string to extract a topic from
	 * @return The topic extracted from the URL string or null if there is no match
	 */
	public String extract(final String string) {
		Matcher m = pattern.matcher(string);
		if (m.find()) {
			/*
			 * Der erste (index 0) match ist der ganze Bereich, der durch den reg. Ausdruck beschrieben wird, die erste
			 * Gruppe (was wir extrahieren wollen) ist also 1:
			 */
